  ...
  ipcMain.handle(
    ...
    async (
      ...
      wrap(async () => {
        ...
        // Thumbnail: renderer will handle resize via canvas (no sharp needed)
        // For now, just copy original as thumbnail placeholder
        try {
          writeFileSync(paths.thumbnail, buffer)
        } catch (e) {
